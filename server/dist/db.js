      ...
      FOREIGN KEY (assigned_to) REFERENCES employees (id)
        ...
        db.get("SELECT count(*) as count FROM employees", (err, row) => {
            ...
            if (row.count === 0) {
                ...
                const stmt = db.prepare("INSERT INTO employees (name, email, role, department, joining_date) VALUES (?, ?, ?, ?, ?)");
                stmt.run("Alice Johnson", "alice@example.com", "Faculty", "Computer Science", "2023-01-15");
                stmt.run("Bob Smith", "bob@example.com", "Admin", "Administration", "2022-05-20");
                stmt.finalize();
                // Seed Assets for Alice
                ...
                assetStmt.run("MacBook Pro M2", "Laptop", "MBP-2023-001", 1, "2023-01-15");
                assetStmt.run("Office Key Card", "Access", "KC-8821", 1, "2023-01-15");
                assetStmt.finalize();
            }
        });
