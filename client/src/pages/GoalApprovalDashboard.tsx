            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <Card className="border-amber-200 bg-amber-50">
                    <CardContent className="pt-4">
                        <div className="text-xl font-bold text-amber-900">{pendingSubmissions.length}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gapx-4 py-4">
                ...
                <div className="space-y-3">
                    ...
                    {pendingSubmissions.map((submission) => (
                        <Card
                            key={submission.id}
                            className={`cursor-pointer border-slate-200 hover:shadow-sm transition-all ${selectedSubmission?.id === submission.id ? 'ring-2 ring-blue-500' : ''
                                }`}
